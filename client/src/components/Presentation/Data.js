...
export const presentationData = {
  ...
  logo: image,
  title: "Learn somethink new everyday",
  paragraph: [
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ut diam laoreet, feugiat est ut, sagittis turpis. Integer pharetra orci molestie justo vestibulum ultrices. Proin sed enim sit amet enim scelerisque efficitur a eget nunc.",
    "Pellentesque maximus sagittis mauris, a interdum velit cursus sit amet. Mauris tincidunt ex mauris, ac sollicitudin felis tincidunt sed. Maecenas ac accumsan lorem, sed ullamcorper dui. Pellentesque rhoncus elit nec porttitor rutrum.",
  ],
};
export const coloredCardData = [
  {
    destination: "Get any course in any domain and learn new skills",
    title: "Find the best course and check for the price evolution",
    imgSrc: "./img/screen-marketplace@2x.png",
    color: "#00ccb1",
  },
  {
    destination: "Create your course and be the best instructor",
    title: "Create your content and help your students to encrease price",
...
export const statsData = [
  {
    imgSrc: "./img/flag.png",
    title: "500k+ categories of course",
    description: "Search for any skill and pick your choice",
  },
  {
    imgSrc: "./img/patients.png",
    title: "1M+ active instructors",
    description: "Interact with your course's creator to learn more",
  },
  {
    imgSrc: "./img/visits.png",
    title: "10K+ new courses everyday",
    description: "Thousands of new free courses and millions of expert courses",
  },
  {
    imgSrc: "./img/doctors.png",
    title: "30M+ users for all over the world",
    description: "Follow courses or create your own",
  },
];

export const officeData = [
  { imageSrc: "./img/istanbul.png", country: "Istanbul", link: "#" },
  { imageSrc: "./img/rome.png", country: "Rome", link: "#" },
  { imageSrc: "./img/mexico-city.png", country: "Mexico City", link: "#" },
  { imageSrc: "./img/curitiba.png", country: "Curitiba", link: "#" },
  { imageSrc: "./img/warsaw.png", country: "Warsaw", link: "#" },
  { imageSrc: "./img/barcelona.png", country: "Barcelona", link: "#" },
];
